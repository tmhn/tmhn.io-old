      ...
      <DocumentTitle title='Projects - Tom Hanson'>
        <div>
          ...
          <div className='pageContent'>
            ...
            <hr />
            <p>As part of my final year studies, I studied Advanced Web Applications with a focus on .Net web apps. The context of the module was
            to produce a web application similar to UCAS that consumes two XML web services whilst being highly functional to the user.</p>
