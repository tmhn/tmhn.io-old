    ...
    <DocumentTitle title="DoppioHealth - Tom Hanson">
        <div>
            ...
            <div className="pageContent">
                ...
                <hr />
                <p>
                    DoppioHealth is a system that was developed as part of my undergraduate
                    ...
                    situations, the DoppioHealth iOS application will be customised for the
                    patient with no excess functionality. The DoppioHealth system comprises of
                    a React.js web application and a React Native iOS application that
                    collaborate together.

                    <br /><br />

                    DoppioHealth originally implemented a Google Blockly visual programming
